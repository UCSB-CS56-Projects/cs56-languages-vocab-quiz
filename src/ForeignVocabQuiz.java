 ...
 public String getRandomWordFromList(){
	...
	testWord = vocabList.get(index);
	    ...
	    if (displayForeignWord)
	       ...
	       return testWord.getForeignWord();//Display foreign worrd	
            }
	    			    				    	    		else{ //if displayForeignWord is false, display english word
		counterPart = testWord.getForeignWord();	    				 return testWord.getEnglishWord();
	    }
}
	  
   	  /** Checks users guess with the correct vocab word	    	    	            *@return boolean - specifies if answer was correct or not
	    */
